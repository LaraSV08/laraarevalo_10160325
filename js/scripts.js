...
console.log("window.screen.availWidth:"+window.screen.availWidth+"px","window.scrren.availHeight:"+window.screen.availHeight+"px");

console.log("document.body.clientWidht:"+document.body.clientWidth+"px","document.body.clientHeight:"+document.body.clientHeight+"px");